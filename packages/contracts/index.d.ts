 ...
 */
export declare const START_BLOCK = 2973474;
/**
 * The address for the DarkForest contract.
 */
export declare const CONTRACT_ADDRESS = "0xDE25DE6a2a968dC89B6e6A935D1708Be59dB0dCd";
/**
 * The address for the initalizer contract. Useful for lobbies.
 */
export declare const INIT_ADDRESS = "0x3700f7298E8F1B9fFbBf2793142AB4A498fB2BD5";
